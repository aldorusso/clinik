...
from app.core.security import get_current_tenant_member, get_current_user
...
async def create_appointment(
    ...
    result = {
        **appointment_with_relations.__dict__,
        ...
        "provider_name": appointment_with_relations.provider.full_name or f"{appointment_with_relations.provider.first_name} {appointment_with_relations.provider.last_name}",
