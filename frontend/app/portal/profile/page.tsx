...
export default function ClientProfilePage() {
  ...
  const getInitials = () => {
    ...
    if (clientCompanyName) {
      return clientCompanyName.slice(0, 2).toUpperCase()
    }
    if (user?.email) {
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <CardTitle className="text-2xl">
                      {firstName && lastName ? `${firstName} ${lastName}` : clientCompanyName || user?.email}
                    </CardTitle>
              ...
              <CardContent className="space-y-6">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="clientCompanyName">Nombre de Empresa</Label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="clientTaxId">RUC / NIT / CIF</Label>
                    <Input
                      id="clientTaxId"
                      value={clientTaxId}
